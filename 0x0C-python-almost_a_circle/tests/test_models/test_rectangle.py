...
class TestRectangle_height(unittest.TestCase):
    """To test Rectangle height attribute initialization."""
...
class TestRectangle_x(unittest.TestCase):
    """To test Rectangle x attribute initialization."""
...
class TestRectangle_y(unittest.TestCase):
    """To test Rectangle y attribute initialization."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """For testing Rect order of attribute initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect : Rectangle to be printed to stdout.
            method: The method to run on rectangle.
        Returns:
            Text to be printed to stdout by calling method on square.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """To test the kwargs update method of the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """To test to_dictionary method of the Rectangle class."""
