...
class TestSquare_instantiation(unittest.TestCase):
    """To test Square class instantiation."""
...
class TestSquare_size(unittest.TestCase):
    """To test size initialization of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """To test Square x attribute initialization."""
...
class TestSquare_y(unittest.TestCase):
    """For testing Square y attribute intitialization."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """For testing order of Square initialization of attributes."""
...
class TestSquare_stdout(unittest.TestCase):
    """For testing __str__ and display Square class methods."""

    @staticmethod
    def capture_stdout(sq, method):
        """Returns the captured text and prints it to stdout.

        Args:
            sq (Square): The Square to be printed to stdout.
            method (str): The method to run on square.
        Returns:
            The printed text to stdout by calling method on square.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Tests update args method of a Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Tests update kwargs method of a Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests used for testing to_dictionary method of class Square."""
